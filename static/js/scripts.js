document.addEventListener("DOMContentLoaded", () => {
    ...
    // ===============================
    // Navbar: dropdown genérico (Fundos, usuário) via [data-dropdown]
    // ===============================
    document.querySelectorAll('.site-nav__user-btn[data-dropdown], .site-nav__link--dropdown[data-dropdown]').forEach(function (btn) {
        btn.addEventListener('click', function (e) {
            ...
            // fecha qualquer outro dropdown aberto primeiro
    ...
    // ===============================
    // Navbar mobile: drawer lateral (hambúrguer)
    // ===============================
    ...
    const DRAWER_BREAKPOINT = 992; // manter em sincronia com o @media (max-width: 991.98px) do CSS
    ...
    if (mobileToggle && mobileMenu) {
        ...
        // Trava o foco (Tab) dentro do drawer aberto
        ...
        // Mantém o estado do drawer/inert consistente ao redimensionar (mobile <-> desktop)
